      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative space-y-6">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex items-center gap-3 sm:gap-4 text-xs text-[#9090a0]">
                  <span className="flex items-center gap-1">
                    <span className="w-4 h-4 rounded-full bg-orange-500/20 flex items-center justify-center text-orange-400">1</span>
                    Draw
                  </span>
                ...
                <button 
                  ...
                  className="w-full sm:w-auto px-6 py-3 text-sm font-medium rounded-full bg-gradient-to-r from-orange-500 to-purple-500 text-white hover:opacity-90 transition-opacity"
                >
                  Try Me ✨
                </button>
              </div>
            ...
            <div className="absolute -bottom-4 -left-4 w-32 h-32 bg-gradient-to-br from-orange-500/20 to-purple-500/20 rounded-full blur-2xl" />
          </div>
        </div>
      </div>
